    ...
    for file in directory.rglob("*.md"):
        if file.name.endswith(".excalidraw.md"):
            with open(file, "w", encoding="utf-8") as file_writer:
                file_writer.write("This file was generated by Excalidraw.\nNormally, we can't show this file on the web.\n\nIf you want to see this file, please open it in Obsidian. \nFor more information, please refer to the [GitHub Repo](https://github.com/yossy4411/note.git).\n")
