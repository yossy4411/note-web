...
description: 
draft: false
created: 2025-04-20T02:04:04+09:00
modified: 2025-07-11T09:25:46+09:00
aliases:
  - インターネット
  - Internet
---
**インターネット** (the Internet) は、[[develop/Knowledge/internet/protocol/_index|インターネット・プロトコル]]を用いて接続された、コンピューター同士の世界規模の情報通信網である。
...
> 
> この章および配下の資料については、**Wikipediaからの出典であること**、**すべてCC BY-SA 4.0に基づき再配布していること**をご理解ください。

## 概要
インターネットは、異なる種類のネットワーク機器や回線、OSを使用していても、**共通の通信ルール（プロトコル）** を用いることで相互に接続されている。この通信ルールの中心となるのが [[TCP-IP|TCP/IP]] であり、これによって世界規模のネットワークが構築・維持されている。
### コンピュータネットワークでは
...
しばしば混同されがちだが、インターネットは**通信網そのもの**であり、[[develop/Knowledge/internet/web/_index|World Wide Web]]はその上で動く**サービスの一つ**である。たとえば、メール、ファイル転送、オンラインゲームもインターネット上のサービスだ。
...
今日のインターネットは、個人の生活から企業、行政、教育医療、エンタメ、経済、金融に至るまで、社会全体に浸透している。特にスマートフォンやクラウドサービス、[[develop/Knowledge/AI/_index|AI]]、IoTの普及によって、その重要性はますます高まっている。
