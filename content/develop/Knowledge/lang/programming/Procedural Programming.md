...
draft: false
showContent: true
created: 2025-05-16T04:50:02+09:00
modified: 2025-07-11T10:23:26+09:00
---
**手続き型プログラミング** (英: Procedural programming) は、コンピュータが実行すべき命令や手続きを、順に記述していくことでプログラムを構成するスタイルの[[Programming Paradime|プログラミングパラダイム]]である。
