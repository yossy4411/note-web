...
modified: 2025-07-11T08:46:07+09:00
---
**インターネット** (the Internet) は、[[IP|インターネット・プロトコル]]を用いて接続された、コンピューター同士の世界規模の情報通信網である。
...
しばしば混同されがちだが、インターネットは**通信網そのもの**であり、[[World Wide Web]] はその上で動く**サービスの一つ**である。たとえば、メール、ファイル転送、オンラインゲームもインターネット上のサービスだ。
