...
showContent: false
slug: uri
created: 2025-04-20T07:50:35+09:00
modified: 2025-07-11T09:42:26+09:00
---
...
URIのスキームは、一般的には[[develop/Knowledge/internet/application/http/_index|HTTP]] (`http://`, `https://`) が使用されるが、他にもFTP (`ftp://`)やメール (`mailto:`)、ローカルファイル (`file://`)などがある。