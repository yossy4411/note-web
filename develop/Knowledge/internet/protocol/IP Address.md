...
modified: 2025-07-11T09:31:47+09:00
---
**IPアドレス**は、[[develop/Knowledge/internet/protocol/_index|インターネット・プロトコル]]上で通信相手を識別するための番号。

## 概要
IPアドレスは、IPネットワーク上のデバイスを識別するために指定する、ネットワーク層における識別用の番号である。データリンク層のMACアドレスを物理アドレスと言うのに対応し、論理アドレスとも。
